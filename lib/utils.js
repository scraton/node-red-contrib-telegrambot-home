...
function updateNodeStatusSent(node) {
  updateNodeStatusSuccess(node, "sent " + (new Date()).toLocaleString());
}

function updateNodeStatusReceived(node) {
  updateNodeStatusSuccess(node, "received " + (new Date()).toLocaleString());
}
...
module.exports = {
  ...
  updateNodeStatusSent: updateNodeStatusSent,
  updateNodeStatusReceived: updateNodeStatusReceived,
  timeUnits: timeUnits
};
